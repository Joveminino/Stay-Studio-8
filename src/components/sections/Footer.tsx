...
const Footer = memo(() => (
  <footer className="bg-primary text-on-primary/60 pt-16 md:pt-24 pb-12 px-6">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-16 md:mb-24">
        <div className="col-span-1 sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm md:text-base text-on-primary/70 leading-relaxed max-w-xs mb-8">
          ...
          <div className="flex gap-4">
            <button aria-label="Siga-nos no Instagram" className="w-10 h-10 rounded-full bg-on-primary/5 flex items-center justify-center hover:bg-on-primary/20 hover:scale-110 transition-all">
              <Instagram className="text-white" size={18} />
            </button>
            <button aria-label="Siga-nos no LinkedIn" className="w-10 h-10 rounded-full bg-on-primary/5 flex items-center justify-center hover:bg-on-primary/20 hover:scale-110 transition-all">
              <Linkedin className="text-white" size={18} />
            </button>
            <button aria-label="Siga-nos no Facebook" className="w-10 h-10 rounded-full bg-on-primary/5 flex items-center justify-center hover:bg-on-primary/20 hover:scale-110 transition-all">
        ...
        <div className="px-2">
          ...
          <ul className="space-y-3 md:space-y-4 text-xs md:text-sm text-on-primary/60 font-medium">
        ...
        <div className="px-2">
          ...
          <ul className="space-y-3 md:space-y-4 text-xs md:text-sm text-on-primary/60 font-medium">
            ...
            <li className="pt-4 border-t border-on-primary/5">
              <span className="text-[10px] text-on-primary/30 uppercase tracking-[0.3em] block mb-1">Base SP Hub</span>
      ...
      <div className="pt-8 md:pt-10 border-t border-on-primary/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] md:text-xs text-on-primary/40">
        ...
        <div className="flex gap-6 font-bold uppercase tracking-widest text-white/40">
